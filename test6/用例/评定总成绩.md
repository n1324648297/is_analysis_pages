...
|主事件流| 1. 查看已有的成绩 <br/> 2. 提交多个实验的成绩和评语 <br/> 3. 系统存储实验成绩和评语<br/> 4. 系统自动计算平均成绩|
...
## 3. 界面设计
- 界面参照: https://n1324648297.github.io/is_analysis/test6/ui/评定成绩.html
...
- API接口调用
    ...
    - 接口3：[getOneTestResults](../接口/setOneTestResults.md)
